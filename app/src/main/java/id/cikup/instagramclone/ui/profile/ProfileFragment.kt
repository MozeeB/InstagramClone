package cookode.instagram_clone.ui.profile
...
import id.cikup.instagramclone.adapter.MyImagesAdapter
...
class ProfileFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        //sesuai kondisi
        btn_edit_account.setOnClickListener {
            ...
            when {
                ...
                getButtonText == "Edit Profile" -> findNavController().navigate(R.id.action_navigation_profile_to_settingActivity)
